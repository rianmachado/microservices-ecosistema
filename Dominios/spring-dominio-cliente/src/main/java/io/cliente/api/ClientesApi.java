...
public interface ClientesApi {
    ...
    @ApiOperation(value = "Delete cliente por identificador", nickname = "deleteCliente", notes = "", tags={ "clientes", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<Void> deleteCliente(@ApiParam(value = "Identificador para localizar cliente a ser deletado",required=true) @PathVariable("clienteId") Long clienteId);


    @ApiOperation(value = "Localizar cliente por identificador", nickname = "getClienteById", notes = "Recupera um cliente", response = Cliente.class, tags={ "clientes", })
    @ApiResponses(value = { 
